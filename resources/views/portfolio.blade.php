        ...
        <header class="fixed top-0 left-0 right-0 z-50 border-b border-zinc-800/80 bg-charcoal/90 backdrop-blur-md">
            <nav class="container mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                ...
                <div class="flex items-center gap-4 sm:gap-6 text-sm">
                    ...
                    <a href="#contact" class="text-accent font-medium hover:underline underline-offset-4">{{ __('portfolio.nav_contact') }}</a>
                    <div class="flex items-center gap-1 border border-zinc-600 rounded-lg p-0.5">
                        <a href="{{ route('locale.switch', 'en') }}" class="px-2.5 py-1 rounded-md text-xs font-medium {{ $locale === 'en' ? 'bg-accent text-charcoal' : 'text-zinc-400 hover:text-white' }} transition-colors">EN</a>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                        ...
                        <article class="lg:col-span-2 rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 sm:p-8 hover:border-accent/50 transition-colors group">
                            ...
                            <ul class="flex flex-wrap gap-2 mb-5">
                                ...
                                <li class="text-xs text-zinc-500 bg-zinc-800/80 px-2.5 py-1 rounded-md">Supply Chain</li>
                            </ul>
                            <a href="#" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 min-h-[44px] px-4 py-3 rounded-lg bg-accent text-charcoal font-semibold text-sm hover:bg-accent-hover transition-colors touch-manipulation">
                        ...
                        <article class="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 sm:p-8 hover:border-accent/50 transition-colors group">
                            ...
                            <a href="https://teal-camel-501086.hostingersite.com/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 min-h-[44px] px-4 py-3 rounded-lg bg-accent text-charcoal font-semibold text-sm hover:bg-accent-hover transition-colors touch-manipulation">
                                <span>{{ __('portfolio.visit_project') }}</span>
                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                            </a>
                        </article>
                        ...
                        <article class="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 sm:p-8 hover:border-accent/50 transition-colors group">
                            ...
                            <ul class="flex flex-wrap gap-2 mb-5">
                                <li class="text-xs text-zinc-500 bg-zinc-800/80 px-2.5 py-1 rounded-md">Marketplace</li>
                            ...
                            <a href="https://seagreen-stork-442565.hostingersite.com/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 min-h-[44px] px-4 py-3 rounded-lg bg-accent text-charcoal font-semibold text-sm hover:bg-accent-hover transition-colors touch-manipulation">
                                <span>{{ __('portfolio.visit_project') }}</span>
                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                            </a>
                        </article>
                        ...
                        <article class="lg:col-span-2 rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 sm:p-8 hover:border-accent/50 transition-colors group">
                            ...
                            <div class="space-y-4 text-zinc-400 text-sm sm:text-base leading-relaxed">
                                ...
                                <p>
                                    <strong class="text-zinc-300">{{ __('portfolio.alzukhruf_label') }}</strong> {{ __('portfolio.alzukhruf_desc') }}
                                </p>
                            </div>
                            <ul class="flex flex-wrap gap-2 mt-5 mb-5">
                                ...
                                <li class="text-xs text-zinc-500 bg-zinc-800/80 px-2.5 py-1 rounded-md">Document Mgmt</li>
                            </ul>
                            <a href="https://lightgoldenrodyellow-hummingbird-955282.hostingersite.com/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 min-h-[44px] px-4 py-3 rounded-lg bg-accent text-charcoal font-semibold text-sm hover:bg-accent-hover transition-colors touch-manipulation">
                                <span>{{ __('portfolio.visit_project') }}</span>
                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                            </a>
                        </article>
                        ...
                        <article class="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 sm:p-8 hover:border-accent/50 transition-colors group">
                            ...
                            <a href="https://azzukhruff.com/" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 min-h-[44px] px-4 py-3 rounded-lg bg-accent text-charcoal font-semibold text-sm hover:bg-accent-hover transition-colors touch-manipulation">
                                <span>{{ __('portfolio.visit_project') }}</span>
                                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                            </a>
                        </article>
            ...
            <section id="contact" class="py-16 sm:py-24 lg:py-32 border-t border-zinc-800/50">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl">
                    ...
                    <div class="flex flex-wrap gap-4 mb-10">
                        ...
                        <a href="https://github.com/mohamedalicoder" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-zinc-600 text-zinc-300 hover:border-accent hover:text-accent transition-colors">
                    ...
                    <form action="#" method="post" class="space-y-5">
                        @csrf
                        <div>
                            <label for="name" class="block text-sm font-medium text-zinc-400 mb-1.5">{{ __('portfolio.contact_name') }}</label>
                            <input type="text" id="name" name="name" required class="w-full px-4 py-3 rounded-lg bg-zinc-900 border border-zinc-700 text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent" placeholder="{{ __('portfolio.contact_name_placeholder') }}">
                        </div>
                        <div>
                            <label for="email" class="block text-sm font-medium text-zinc-400 mb-1.5">{{ __('portfolio.contact_email') }}</label>
                            <input type="email" id="email" name="email" required class="w-full px-4 py-3 rounded-lg bg-zinc-900 border border-zinc-700 text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent" placeholder="{{ __('portfolio.contact_email_placeholder') }}">
                        </div>
                        <div>
